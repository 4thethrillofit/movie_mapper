...
this.markers.push(a);g.call(this,a,b)}};d.prototype.createMarkersFromLatLngs=function(b){b.forEach(function(a){this.addMarker(a)},this);c.call(this,this.map)};d.prototype.deleteMarkers=function(){c.call(this,null);this.markers=[]};e.exports=d},{}],3:[function(d,e,f){e.exports=function(c){google.maps.event.addDomListener(window,"load",function(){var d={center:new google.maps.LatLng(37.767967,-122.442717),zoom:13};c.GoogleMaps.map=new google.maps.Map(document.getElementById("map-canvas"),d)})}},{}],
4:[function(d,e,f){Storage.prototype.setObject=function(c,d){this.setItem(c,JSON.stringify(d))};Storage.prototype.getObject=function(c){return(c=this.getItem(c))&&JSON.parse(c)}},{}],5:[function(d,e,f){var c=d("./utils");d=function(){this.data};d.prototype.filterBy=function(b,a){var c=[];this.data.forEach(function(d){d.locations&&d[b].trim()===a.trim()&&c.push(d)});return g(c)};d.prototype.fetchCachedOrFreshData=function(){function b(){var a;$.ajax({url:"http://data.sfgov.org/resource/yitu-d5am.json",
dataType:"json",async:!1,success:function(b){a=b}});return a}if(Modernizr.localstorage){var a=localStorage.getObject("SFMoviesData");if(a)this.data=a;else{this.data=b();try{localStorage.setObject("SFMoviesData",this.data)}catch(c){return!1}}}else this.data=b()};d.prototype.collectAllAttributes=function(b){var a=[];this.data.forEach(function(c){c.locations&&a.push(c[b].trim())});return c.removeDuplicateRecords(a)};e.exports=d;var g=function(b){var a=c.cloneArrayOfObjects(b);(function(){a.forEach(function(a){a.errors||
(a.locations=a.locations.concat(", San Francisco, CA"))})})();(function(){a.forEach(function(a){a.errors||!a.locations.indexOf("(")&&!a.locations.indexOf(")")||(a.locations=a.locations.replace("(","").replace(")",""))})})();(function(){a.forEach(function(a){!a.errors&&a.locations.indexOf("&")&&(a.locations=a.locations.replace(/&/g,"and"))})})();return a}},{"./utils":7}],6:[function(d,e,f){function c(c){c.forEach(function(b){b.errors&&($("div.alert-info").is(":hidden")&&$("div.alert-info").show(),
$("div.alert-info").append("<p>We could not locate <em>"+b.locations+'</em> for the movie <strong>"'+b.title+'"</strong></p>'))})}TypeaheadClient={data:{},context:{},initialize:function(c){0===Object.keys(this.data).length?console.log("EMPTY TYPEAHEAD DATA"):(this.context=c,$("#title.typeahead").typeahead({name:"movieTitles",local:this.data.titles,items:8,header:"<div class='tt-header'>Movie Titles</div>"}),$("#director.typeahead").typeahead({name:"directors",local:this.data.directors,items:8,header:"<div class='tt-header'>Directors</div>"}),
$("#release_year.typeahead").typeahead({name:"releaseYears",local:this.data.releaseYears.sort(function(b,a){return a-b}),items:8,header:"<div class='tt-header'>Release Years</div>"}))},setupListeners:function(){$("input#title.typeahead").on("typeahead:selected",this.selectedCallback);$("input#director.typeahead").on("typeahead:selected",this.selectedCallback);$("input#release_year.typeahead").on("typeahead:selected",this.selectedCallback)},selectedCallback:function(d,b){$("div.alert-info").empty();
$("div.alert-info").hide();TypeaheadClient.context.GoogleMaps.deleteMarkers();$(this).parent().siblings().children("input.tt-query").val("");var a=App.SFMoviesClient.filterBy(d.currentTarget.id,b.value),a=App.GoogleMaps.getBatchLatLngs(a);TypeaheadClient.context.mobileMediaQuery.matches||c(a);TypeaheadClient.context.GoogleMaps.createMarkersFromLatLngs(a)}};e.exports=TypeaheadClient},{}],7:[function(d,e,f){Utils={removeDuplicateRecords:function(c){return c.filter(function(d,b){return c.indexOf(d)===
b})},cloneArrayOfObjects:function(c){return c.map(function(c){return $.extend({},c)})}};e.exports=Utils},{}]},{},[1]);